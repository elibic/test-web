...
// ── חילוץ ערכת-נושא מאתר אינטרנט (דורש Blaze לרשת-יוצאת) ──────────────────────
// GET https://.../extractTheme?url=https://hotel.example.com  ->  { colors:[{hex,n}], fonts:[...] }
// cors:true פותח קריאה מהדפדפן (setup.html). best-effort: סורק HTML + עד 4 גיליונות-סגנון.
